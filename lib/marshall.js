...
function write(ps, ele, data) {
  switch (ele.type) {
    ...
    case 'v':
      ...
      if (data[1] === null) {
        // write an empty int array, to represent null, compare https://github.com/Chris927/dbus-victron-virtual/commit/b1167dd2d9a734ea5cb0233af294a2d9a6c4f278
        write(ps, signatureEle, 'ai');
        write(ps, { type: 'a', child: [{ type: 'i' }] }, []);
      } else {
